...
public class RoboticCat extends RoboticPet implements PlayInKittyCourtyard{
    public RoboticCat(String name, boolean isAlive, int boredom, int batteryLevel, int maintenanceLevel, int oilLevel) {
    ...
    public void playInKittyCourtyard() {
        ...
        if (maintenanceLevel > 0 && maintenanceLevel <= 6) {
            System.out.println("Hmmmm. As " + name + " whips their tail, it looks as though it might fall off. Might be " +
                    "time for servicing.");
        }
